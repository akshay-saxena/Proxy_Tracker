...
public class ViewfinderView extends View {
    ...
    private int mDefaultBorderColor = -1;
    private final int mDefaultBorderStrokeWidth = 4;
    private final int mBorderLineLength = 60;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        this.mDefaultBorderColor = attributes.getColor(R.styleable.zxing_finder_zxing_viewfinder_border,
                resources.getColor(R.color.zxing_viewfinder_border));
    ...
    private void drawInfoText(Canvas canvas){
        ...
        canvas.drawText("Scan Qr Code", framingRect.left + 20, framingRect.bottom + 120, paint);
    }
